...
/**
 *  Main Activity : Get the Fib Number on screen either from JAVA or C++
 */
public class MainActivity extends AppCompatActivity {
    ...
    private void subsribeToViewModel() {
        ...
        fibNumViewModel.getFibNumberList().observe(this, fibNumList -> {
            fibNumberList.clear();
    ...
    public void onRadioButtonClicked(View view) {
        ...
        switch (view.getId()) {
            case R.id.Java:
                if (checked) {
                    Log.d(TAG, "get Fib num from JAVA");
                    startIndex = 0;
                    endIndex = 0;
                    fibNumViewModel.getFibNumberList(FibNumViewModel.DATASOURCE.JAVA, MAX_FIB_NUM_INDEX);
                }
            ...
            case R.id.JNI:
                if (checked) {
                    Log.d(TAG, "get Fib num from JNI");
                    startIndex = 0;
                    endIndex = 0;
